...
//Exercise no 29
let favorite_fruits = ['mango', 'apple', 'bananas!'];
...
let new_users = ["user1", "admin", "user6", "user7", "user8"];
...
//Exercise  no 34
let pizzas = ["pepproni", "chicken bbq", "bbq tikqa"];
...
// Exercise no 37
function make_shirt2(size = "large", text = "I Love type script") {
